...
To discover a further extreme of the welfare-equality tradeoff phenomenon in underdemanded markets, we can use students&rsquo; preferences as primary tiebreakers; then, any of the four methods above can be used to break the remaining ties. This welfare tiebreaking rule (WTB) reflects the realistic assumption that a given school marginally prefers students who prefer it. WTB dominates STB in overdemanded markets, and in all markets, the difference between WXTB and WHTB (that is, WTB where XTB and HTB are used as secondary tiebreakers, respectively) vanishes, which suggests that the WTB family of algorithms has interesting properties that I intend to investigate formally.  
